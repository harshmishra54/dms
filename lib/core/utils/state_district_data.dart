const Map<String, List<String>> stateDistrictMap = {
  ...
  "Chhattisgarh": [
    ...
    "Gaurella-Pendra-Marwahi", "Janjgir-Champa", "Jashpur", "Kabirdham",
  ...
  "Uttar Pradesh": [
    ...
    "Faizabad", "Farrukhabad", "Fatehpur", "Firozabad", "Gautam Buddh Nagar",
...
final Map<String, int> stateIdMap = {
  for (int i = 0; i < stateDistrictMap.keys.length; i++)
    stateDistrictMap.keys.elementAt(i): i + 1
};

// Function to get a district -> ID map for a given state
Map<String, int> getDistrictIdMap(String state) {
  final districts = stateDistrictMap[state] ?? [];
  return {
    for (int i = 0; i < districts.length; i++) districts[i]: i + 1,
  };
}