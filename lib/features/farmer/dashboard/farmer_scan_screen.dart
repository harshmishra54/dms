...
class FarmerScanScreen extends StatefulWidget {
  const FarmerScanScreen({super.key});

  @override
  State<FarmerScanScreen> createState() => _ScanQRScreenState();
}

class _ScanQRScreenState extends State<FarmerScanScreen> {
  String scannedUID = '';
