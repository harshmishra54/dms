...
class FillDetailsForm extends StatefulWidget {
  ...
  @override
  State<FillDetailsForm> createState() => _FillDetailsFormState();
}

class _FillDetailsFormState extends State<FillDetailsForm> with SingleTickerProviderStateMixin {
  ...
  void _onMobileChanged() async {
    ...
    if (phone.length == 10) {
      ...
      // 👇 Handle case: Farmer not found
        ...
        // Add slight delay for user to read snackbar before navigating
  ...
  Future<void> _submitForm() async {
    ...
    if (provider.errorMessage != null) {
      ...
      _showSnack(provider.response!.message, color: Colors.purple, icon: Icons.check_circle);
      ...
      child: Column(
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: _decor('Enter 10-digit mobile number', prefixIcon: Icons.phone),
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  readOnly: true,
                  enableInteractiveSelection: false, // prevents text selection
                  showCursor: false, // hide blinking cursor
                  decoration: _decor('Expected Dealer', compact: true, prefixIcon: Icons.store),
                  onTap: () {
                    FocusScope.of(context).unfocus(); // unfocus immediately if tapped
                  },
                ),
